...
import transformers
from prompt_processor import RAGDataHandler, CODAPromptGenerator2
import argparse
...
def main():
    ...
    parser.add_argument('--metadata_file', type=str, default="processed_outputs_v2/cleaned_val_metadata.json", help='Path to the metadata file')
    ...
    prompt_generator = CODAPromptGenerator2(rag_handler)
    
    print("Loading test dataset...")
    dataset = load_dataset("ntudlcv/dlcv_2024_final1", split="val")
 ...
 # Create directory if it doesn't exist
    save_path = os.path.join(args.output_path, 'val_submission.json')
